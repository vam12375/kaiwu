...
def recognize_intent(user_input: str, model: str = None) -> dict:
    ...
    # ════════════════════════════════════
    # 第二层半：营销方案优先级匹配（LLM易误判为node5营销文案，关键词先拦截）
    # ════════════════════════════════════
    if any(kw in lower_input for kw in ["营销方案", "营销策划", "营销推广", "如何营销", "怎么营销", "怎么做营销", "如何推广", "怎么推广", "怎么做推广"]):
    ...
    kw_map = [
        ...
        (["产品设计", "做什么产品", "做哪些产品", "做产品", "产品规划", "设计产品"], "3"),
